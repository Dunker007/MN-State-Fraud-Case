...
const tabs: Tab[] = [
    ...
    { id: 'intel', label: 'INTEL', icon: Newspaper, description: 'Live News Feed', href: '/?tab=intel' },
    { id: 'investigation', label: 'INVESTIGATION', icon: Target, description: 'Investigation Hub', href: '/?tab=investigation' },
