...
const tabs: Tab[] = [
    { id: 'overview', label: 'PROJECT CROSSCHECK', icon: LayoutDashboard, description: 'Executive Summary', href: '/' },
    { id: 'ops_center', label: 'MN FRAUD WATCH', icon: Shield, description: 'Strategic Command', href: '/ops-center' },
    ...
    { id: 'intel', label: 'INTEL', icon: Newspaper, description: 'Live News Feed', href: '/intel' },
    { id: 'investigation', label: 'INVESTIGATION', icon: Target, description: 'Investigation Hub', href: '/investigations' },
    { id: 'org_chart', label: 'THE BLUEPRINT', icon: Shield, description: 'Structural Failure Analysis', href: '/org-chart' },
    ...
    { id: 'database', label: 'MN LICENSE DATABASE', icon: Database, description: 'Full Provider Masterlist', href: '/database' },
