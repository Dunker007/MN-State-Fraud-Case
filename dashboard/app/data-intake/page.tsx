...
import { Upload, FileText, CheckCircle, RefreshCw, Lock, ShieldCheck } from 'lucide-react';

// Simple PIN for access control (not in nav, but still protected)
const ACCESS_PIN = '1776';
            ...
            {!isUnlocked ? (
                ...
                <div className="max-w-md mx-auto mt-32">
                    <div className="text-center mb-8">
                        ...
                        <h1 className="text-2xl font-bold text-zinc-300 mb-2">Data Intake Center</h1>
                        <p className="text-sm text-zinc-500">Enter access PIN to continue</p>
                    </div>
                    ...
                    <form onSubmit={handlePinSubmit} className="space-y-4">
                        <input
                            ...
                            className={`w-full bg-zinc-900 border ${pinError ? 'border-red-500' : 'border-zinc-700'} rounded-lg px-4 py-3 text-center text-2xl tracking-[0.5em] focus:border-neon-blue outline-none`}
                            autoFocus
                        />
                        {pinError && (
                        ...
                        <button
                            type="submit"
                            className="w-full bg-zinc-800 hover:bg-zinc-700 border border-zinc-700 rounded-lg py-3 font-bold transition-colors"
                        >
                            Unlock
                        </button>
                    </form>
                    ...
                    <p className="mt-8 text-[10px] text-zinc-700 text-center">
                        This page is not linked in navigation for security.
                    </p>
                </div>
            ) : (
                /* Unlocked Content */
                <div className="max-w-2xl mx-auto space-y-8">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold text-neon-blue">Data Intake Center</h1>
